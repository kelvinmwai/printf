 ...
 * Return: Always 3
 */
int append_hexa(char ascii_code, char buffer[], int k)
{
...
/**
 * convert_size_number - Convert number to the specified size
...
/**
 * convert_size_unsgnd - fix a number to the specified size
 * @num: Number to be resized
 * @size: Number indicating the type to be casted
 *
 * Return: value of num after conversion
 */
